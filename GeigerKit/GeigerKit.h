...
#define PIEZO_SIG_PIN     16             // (A2) signal pin to control piezo
#define ALARM_PIN         15             // (A1) Outputs HIGH when Alarm triggered
//                        14             // (A0) unused
#define LED_PIN           13             // for debug only - flashes 5X at startup
#define TONE_PIN          12             // output to speaker or piezo for tone mode
#define NULL_BTN_PIN      11             // Null button used to set the null point in tone mode
...
#define TONE_MAX_FREQ        4200       // maximum frequency that will be generated by the CPMtoTone function
...
#define LOGGING_PERIOD_MAX   1440       // maximum value for the logging interval
#define DOSE_RATIO_MAX       2000       // maximum value for the CPM to dose unit conversion ratio
...
#define LOGGING_PERIOD     1            // defaults a 1 min logging period
...
#define SCALER_ADDR       42 // boolean - 1 byte
...
#if (!TONE_MODE)
prog_char string_8[] PROGMEM = "REG. VOLTAGE";
#else
prog_char string_8[] PROGMEM = "TONE SENSITIVITY";
prog_char string_9[] PROGMEM = "REG. VOLTAGE";
#endif
...
#else
#if (OLD_BARGRAPH)
//Custom characters used for original bar graph
byte bar_0[8] = {
...
#else
// custom characters used for new bar graph
